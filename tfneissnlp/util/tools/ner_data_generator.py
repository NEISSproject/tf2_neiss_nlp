...
def txt2json(conll_path: str, outputfolder, coarse_grained=False, val_ratio=0.0, test_ratio=0.0, shuffle=False,
             strip_bi=False):
...
def main(args):
    ...
    if str(args.file_list).endswith(".txt"):
        txt2json(input_file, args.out_folder, coarse_grained=args.coarse_grained,
