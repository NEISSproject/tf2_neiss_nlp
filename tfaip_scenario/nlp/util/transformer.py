    ...
    def __init__(
        ...
        **kwargs,
        ...
        if whole_word_attention:
            self.window_mha = MultiHeadAttention(
                d_model,
                num_heads,
                attention_type=AttentionType.WindowedSelfRelativeAttention
                if with_rel_pos
...
class Encoder(tf.keras.layers.Layer):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        attention_weight_tensor = tf.stack(attention_weight_list, axis=1)
        return x, attention_weight_tensor # (batch_size, input_seq_len, d_model), (encoding_layer_number, ?, head_number,...,...)
...
class BERT(tf.keras.models.Model):
    def __init__(self, params: "ModelMLMParams"):
        ...
        self._encoder = Encoder(
            ...
            input_vocab_size=self._params.target_vocab_size,
